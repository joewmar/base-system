        ...
        <div class="h-fit m-5">
            <div class="pt-12 w-full h-full flex flex-col space-y-10 justify-center">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center pt-10 "> 
                    <a href="{{route('farm.information.farm')}}" class="p-10 rounded-lg items-center text-center shadow-xl hover:bg-slate-300   hover:text-gray-700">
                        <i class="text-6xl fa-solid fa-house-chimney-window"></i>
