...
<div class="grid overflow-y-hidden grid-cols-5 grid-rows-10 md:w-screen h-screen">
    ...
    <nav class="bg-transparent">
        ...
        <div class="relative flex h-16 items-center justify-between">
            ...
            <!-- Mobile menu button-->
            <button ng-click="mobileMenu = !mobileMenu" type="button" class="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-controls="mobile-menu" aria-expanded="false">
    ...
    <div ng-class="mobileMenu ? 'block' : 'hidden' " class="hidden md:block bg-transparent overflow-y-auto col-span-7 md:col-span-1 row-span-11 md:row-span-9 ">
