<div class="w-screen h-screen fixed flex justify-center items-center top-0 left-0 bg-slate-600 bg-opacity-65">
    <div class="relative flex flex-col items-center max-w-lg gap-4 p-6 rounded-md shadow-md sm:py-8 sm:px-12 bg-white ">
        ...
        <h2 class="text-2xl font-semibold leadi tracki">Quis vel eros donec ac odio tempor.</h2>
        <p class="flex-1 text-center dark:text-gray-400">Tempora ipsa quod magnam non, dolores nemo optio. Praesentium soluta maiores non itaque aliquam sint.</p>
        <button type="button" class="px-8 py-3 font-semibold rounded-full dark:bg-violet-400 dark:text-gray-900">Start recycling</button>
    </div>
</div>